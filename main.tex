...
\pdfinfo
{
    ...
    /Subject Symulacja środowiska miejskieg. Systemy Fuzji danych.
    /Keywords Symulacja, symulator, środowsko miejskie, fuzja danych, śledzenie obiektów, fuzja informacji
}
