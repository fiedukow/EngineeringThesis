...
\section{Cel pracy}
\par{
Celem pracy jest zaprojektowanie architektury i zaimplementowanie symulatora środowiska miejskiego. W ramach projektowania, stworzenie odpowiedniego modelu a także jego weryfikacja.
}
\par{
Celem pracy jest również stworzenie funkcjonalnej implementacji takiego symulatora.
}
\par{
Na bazie powstałej wcześniej abstrakcyjnej architektury, ma powinien powstac symulator mający stanowić źródło danych testowych dla systemu ich fuzji. Szczegółowe wymagania dla referencyjnej implementacji opisano w rozdziale 3.1.
}
\par{
Dodatkowo zbadano jakiego rodzaju ograniczenia sprzętowe są współcześnie kluczowe dla wydajności omawianego systemu.
}