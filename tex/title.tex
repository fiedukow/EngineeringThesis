...
\begin{titlepage}
	...
	\vspace*{2\baselineskip}{\huge\bfseries Implementacja symultora środowiska miejskiego na potrzeby systemu fuzji danych
	\par}
    ...
    {\itshape
    \par{
    This thesis describes approach to creating simulating applications 
    feeding  data fusion systems and introduces problems associated with it.
	}
	\par{    
