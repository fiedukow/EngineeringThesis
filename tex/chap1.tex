...
\par{
Analogicznie sprawa wygląda jeśli chodzi o opóźnienia (hamowanie), które wg. literatury [9] wynoszą $3.0-4.5m/s^2$ dla samochodów w zależności od rodzaju pojazdu jak i stanu nawierzchni. Oraz $6.0-9.8m/s^2$ dla motocykli.
}
\subsubsection{Piesi}
\par{
